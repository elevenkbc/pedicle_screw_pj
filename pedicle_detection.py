...
if os.name == "nt":
    ...
    lib = CDLL("/home/raoblack/Documents/darknet/libdarknet.so", RTLD_GLOBAL)
...
def cvDrawBoxes(detections, img, colors):
    #colors is dictionary key is object label value is rgb value
    ...
    for detection in detections:
        ...
        pt1 = (xmin, ymin)
        pt2 = (xmax, ymax)
        cv2.rectangle(img, pt1, pt2, colors[detection[0]], 1)
        cv2.putText(img,
                    detection[0]+
                    " [" + str(round(detection[1] * 100, 2)) + "%]",
                    (pt1[0], pt1[1] - 5), cv2.FONT_HERSHEY_SIMPLEX, 0.5,
                    colors[detection[0]], 1)
        if detection[0] == 'eyes':
            eyes_center = ((pt2[0] + pt1[0])//2, (pt2[1] + pt1[1])//2)
            cv2.circle(img, eyes_center, 3, colors[detection[0]], -1)
    return img
...
def detectPedicle():
    ...
    # imagePath = "/home/raoblack/Documents/darknet/Projects/Pedicle0617/Images/img0012.jpg"
    
    # file_name = "img0011.jpg"
    # file_name = "img0017.jpg"
    # file_name = "img0031.jpg"
    # file_name = "img0040.jpg"
    # file_name = "img0044.jpg"
    # file_name = "img0059.jpg"
    # file_name = "img0069.jpg"
    # file_name = "img0089.jpg"
    # file_name = "img0109.jpg"
    # file_name = "img0129.jpg"
    # file_name = "img0149.jpg"
    # file_name = "img0159.jpg"
    # file_name = "img0161.jpg"
    # file_name = "img0169.jpg"
    file_name = "img0171.jpg"

    imagePath = os.path.join("dataset/img/", file_name)
    detections = performDetect(imagePath = imagePath, thresh = 0.35, configPath = "/home/raoblack/Documents/darknet/Projects/Pedicle0617/cfg/yolov3-tiny-custom.cfg", weightPath = "/home/raoblack/Documents/darknet/Projects/Pedicle0617/backup/yolov3-tiny-custom_51000.weights", metaPath= "/home/raoblack/Documents/darknet/Projects/Pedicle0617/cfg/Pedicle0617_abspath.data", showImage= False, makeImageOnly = False, initOnly= False)
    
    img = cv2.imread(imagePath)

    colors = {'line': [0, 12 ,255], 'nose': [225, 23, 13], 'eyes': [0, 255, 255]}
    img = cvDrawBoxes(detections, img, colors)
    ...
    if not os.path.exists(os.path.join(SaveFolder, 'pedicle_detection')):
        os.makedirs(os.path.join(SaveFolder, 'pedicle_detection'))
  
    cv2.imwrite(os.path.join(SaveFolder, 'pedicle_detection', file_name), img)
